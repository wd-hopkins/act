...
func TestActionCache(t *testing.T) {
	...
	repo := "https://github.com/wd-hopkins/act-test-actions"
	refs := []struct {
		Name     string
		CacheDir string
		Repo     string
...
func TestActionCacheFailures(t *testing.T) {
	...
	ctx := context.Background()
	cacheDir := "nektos/act-test-actions"
	repo := "https://github.com/wd-hopkins/act-test-actions-not-exist"
	repoExist := "https://github.com/wd-hopkins/act-test-actions"
	refs := []struct {
		Name     string
		CacheDir string
		Repo     string
